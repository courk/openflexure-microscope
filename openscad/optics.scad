...
camera_mount_top = dt_bottom - 3 - (optics=="rms_f40d16"?0:8) - (optics=="rms_infinity_f50d13"?20:0); //the 50mm tube lens requires the camera to stick out the bottom.
bottom = camera_mount_top-camera_mount_height(); //nominal distance from PCB to microscope bottom
fl_cube_bottom = -8; //bottom of the fluorescence filter cube
